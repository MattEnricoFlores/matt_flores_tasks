...
<?php
echo '<span style="color:#FFFFFF"> Matt Flores <br></span>';
echo '<span style="color:#FFFFFF">BBCAP22</span>';
?>

<h3>3.2 Write PHP code to display the following message.</h3>

<?php
echo '<span style="color:#FFFFFF">Hello world! My name is "David"</span>';
?>
